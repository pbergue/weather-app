    ...
    return (
      <div className="left-side">
        ...
        <div className="day-cycle">
          <img id="semi-round" src="/semi-round.svg" />
          <img id="orb" src="/sun.svg" style={{transform: `rotate(${this.degSunriseSunset()}deg)`}}/>
        </div>
        <div className="sun-hours">
          <h4 className="sunrise-sunset"><img id="sunrise" src="/sunrise.svg" /><span>{("0" + new Date((this.props.selectedCity.sys.sunrise + this.props.selectedCity.timezone) * 1000).getHours()).slice(-2) + ":" + ("0" + new Date((this.props.selectedCity.sys.sunrise + this.props.selectedCity.timezone) * 1000).getMinutes()).slice(-2)}</span></h4>
          <h4 className="sunrise-sunset"><img id="sunset" src="/sunset.svg" /><span>{("0" + new Date((this.props.selectedCity.sys.sunset + this.props.selectedCity.timezone) * 1000).getHours()).slice(-2) + ":" + ("0" + new Date((this.props.selectedCity.sys.sunset + this.props.selectedCity.timezone) * 1000).getMinutes()).slice(-2)}</span></h4>
        </div>
